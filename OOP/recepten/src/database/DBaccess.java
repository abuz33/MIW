...
public class DBaccess {
    ...
    private static final String MAIN_USER = "jamieoliver";
    private static final String MAIN_USER_PASSWORD = "nakedchef";
    private static final String DATABASE_NAME = "recepten";  // schema naam
